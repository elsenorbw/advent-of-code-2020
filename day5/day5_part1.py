...
def find_highest_seat_number(filename: str) -> int:
    """
    Given an input file of FBLR encoded seat numbers, find the highest value
    """
    highest_seat = None
    with open(filename, "r") as f:
        for this_line in f:
            ...
            if "" != this_line:
                ...
                if highest_seat is None or this_seat > highest_seat:
                    highest_seat = this_seat
    return highest_seat


part1_result = find_highest_seat_number("input.txt")
